...
export default {
  ...
  computed: {
    topStyle () {
      let style = {}
      if (this.bottomShow) style.height = this.height * this.topWeight / (this.topWeight + this.bottomWeight) + 'px'
      return style
    },
    bottomStyle () {
      let style = {}
      if (this.topShow) style.height = this.height * this.bottomWeight / (this.topWeight + this.bottomWeight) + 'px'
      return style
    }
  },
  methods: {
