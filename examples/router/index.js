  ...
  routes: [
    {
      path: '/',
      name: 'index',
      component: () => Promise.resolve((require('../views/index.vue'))),
      children: [
        {
          path: 'LoadServerData',
          name: 'LoadServerData',
          component: () => Promise.resolve(require('../views/LoadServerData'))
        },
        {
          path: 'NavTree',
          name: 'NavTree',
          component: () => Promise.resolve(require('../views/NavTree'))
        },
        {
          path: 'LoadLocalData',
          name: 'LoadLocalData',
          component: () => Promise.resolve(require('../views/LoadLocalData'))
        },
        {
          path: 'autoLine',
          name: 'autoLine',
          component: () => Promise.resolve(require('../views/autoLine'))
        },
        {
          path: 'border',
          name: 'border',
          component: () => Promise.resolve(require('../views/border'))
        },
        {
          path: 'SubmitAllChange',
          name: 'SubmitAllChange',
          component: () => Promise.resolve(require('../views/SubmitAllChange'))
        },
        {
